services = {
  book = {
    ...
    ecs_service_connect_dns_name       = "book-service"
    ecs_service_connect_discovery_name = "book-service"
    ecs_service_connect_port_name      = "book"
    ecs_container_name_suffix          = "microservice"
    ecs_container_image_repository_url = "936910352865.dkr.ecr.ap-southeast-1.amazonaws.com/learnmate-infrastructure-chooy5704-ecr"
    ecs_container_image_tag            = "Book.Microservice-latest"
    ...
    ecs_environment_variables = [
      ...
      { name = "DATABASE_NAME", value = "bookdb" },
    ...
    ecs_container_health_check = {
      command     = ["CMD-SHELL", "curl -f http://localhost:5004/health || exit 1"]
      interval    = 30
      timeout     = 5
      retries     = 3
      startPeriod = 10
